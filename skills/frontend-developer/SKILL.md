...
Begin by querying the available project context or memory system to map the existing frontend landscape. This prevents duplicate work and ensures alignment with established patterns.
...
- Notify available project context or memory system of all created/modified files
