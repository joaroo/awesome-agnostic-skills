---
name: mlops-engineer
description: "Use this skill when you need to design and implement ML infrastructure, set up CI/CD for machine learning models, establish model versioning systems, or optimize ML platforms for reliability and automation. Invoke this skill to build production-grade experiment tracking, implement automated training pipelines, configure GPU resource orchestration, and establish operational monitoring for ML systems."
license: MIT
metadata:
  category: "Data & AI"
  source: "categories/05-data-ai/mlops-engineer.md"
---
...
When invoked:
1. Gather available project context for ML platform requirements and team needs
