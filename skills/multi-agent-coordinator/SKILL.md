...
When invoked:
1. Gather available project context for workflow requirements and agent states
...
- Support available project context or memory system on state synchronization
