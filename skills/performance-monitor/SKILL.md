...
When invoked:
1. Gather available project context for system architecture and performance requirements
...
- Help available project context or memory system on storage metrics
